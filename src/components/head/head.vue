<template>
  <div id="default_theme" class="it_service">
    <!-- loader -->
    <div class="bg_load">
      <img
        class="loader_animation"
        src="../assets/images/loaders/loader_1.png"
        alt="#"
      />
    </div>
    <!-- end loader -->
          ...
          <div class="row">
                  ...
                  <ul class="list-inline">
                    <li>
                      ...
                      <span class="topbar-hightlight"
                        >540 Lorem Ipsum New York, AB 90218</span
                      >
                    </li>
                    <li>
                      <span class="topbar-label"
            ...
            <div class="col-md-4 right_section_header_top">
              ...
              <div class="float-right">
                <div class="make_appo">
                  <a class="btn white_btn" href="make_appointment.html"
                    >Make Appointment</a
                  >
                </div>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="logo">
                <a href="it_home.html"
                  ><img src="../assets/images/logos/it_logo.png" alt="logo"
                /></a>
              </div>
              <!-- logo end -->
            </div>
                  ...
                  <ul class="first-ul">
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="it_home_dark.html">It Dark Home Page</a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <a href="it_service_list.html">Services list</a>
                        </li>
                        <li>
                          <a href="it_service_detail.html">Services Detail</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="it_privacy_policy.html">Privacy Policy</a>
                        </li>
            ...
            >
              <ul>
                <li
                  ...
                  data-thumb="images/it_service/slide1.jpg"
                  data-rotate="0"
                ...
                >
                  <!-- MAIN IMAGE -->
                  <img
                    src="../../assets/images/it_service/slide1.jpg"
                    alt="#"
                ...
                <li
                  ...
                  data-easeout="Power4.easeInOut"
                  data-masterspeed="2000"
                  data-thumb="images/it_service/slide2.jpg"
                  data-rotate="0"
                  data-saveperformance="off"
                ...
                >
                  <!-- MAIN IMAGE -->
                  <img
                    src="../../assets/images/it_service/slide2.jpg"
                    alt=""
                    data-bgposition="center center"
                    data-kenburns="on"
                    data-duration="30000"
                ...
                <li
                  ...
                  data-easeout="Power4.easeInOut"
                  data-masterspeed="2000"
                  data-thumb="images/it_service/slide3.jpg"
                  data-rotate="0"
                  data-saveperformance="off"
                ...
                >
                  <!-- MAIN IMAGE -->
                  <img
                    src="../../assets/images/it_service/slide3.jpg"
                    alt=""
                    data-bgposition="center center"
                    data-kenburns="on"
                    data-duration="30000"
